...
- Hovered units are published through both FFXIV's UI mouseover and Dalamud's shared field mouseover targets for compatibility with action plugins such as MOAction.
